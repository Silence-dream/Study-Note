<template>
  <div>
    ...
    <div class="share_code">
      ...
      <img src="../../asserts/images/4-4.png" height="212" class="code_img" alt="">
    </div>
    <div class="share_cover" v-show="showHide" @click="showCover" >
      <img src="../../asserts/images/5-2.png" alt="">
    </div>
  </div>
</template>
...
export default {
  ...
  created() {
    this.computedScore();
    this.getScoreTip();
    document.body.style.backgroundImage = "url('../../asserts/images/4-1.jpg')";
  },
  methods: {
    //计算分数
    computedScore() {
...
<style lang="scss">
body {
  background-image: url("../../asserts/images/4-1.jpg");
  padding-top: 1.2rem;
}
.your_scores_container {
  width: 9.7rem;
  height: 9.1rem;
  background: url("../../asserts/images/4-2.png") no-repeat;
...
.share_button {
  ...
  background: url("../../asserts/images/4-3.png") no-repeat 0.4rem 0;
...
.share_cover {
  ...
  top: 0;
  left: 0;
  background: url("../../asserts/images/5-1.png") no-repeat;
  background-size: 100% 100%;
  opacity: 0.92;
}
.share_img {
